...
object EnrichmentConf {
  ...
  final case class SqlQueryConf(
    ...
    def enrichment[F[_]: Async: Clock: ContextShift](shifter: ShiftExecution[F]): F[SqlQueryEnrichment[F]] =
  ...
  final case class IpLookupsConf(
    ...
    def enrichment[F[_]: Async: ContextShift]: F[IpLookupsEnrichment[F]] =
